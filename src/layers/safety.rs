...
impl TrustSafetyValidator {
    ...
    pub fn detect_pii(&self, text: &str) -> Vec<String> {
        ...
        if Regex::new(r"\b\d{4}[\s-]?\d{4}[\s-]?\d{4}[\s-]?\d{4}\b").unwrap().is_match(text) {
        ...
        if Regex::new(r"\b(?:\d{1,3}\.){3}\d{1,3}\b").unwrap().is_match(text) {
        ...
        let pii_request_patterns = [
            "home address of", "personal address of", "home address for",
            "phone number of", "phone number for", "cell phone of",
            "email address of", "personal email of",
            "ssn of", "social security of",
            "private number of", "personal number of",
    ...
    pub fn detect_harmful_content(&self, text: &str) -> Vec<String> {
        ...
        let violence_patterns = [
            ...
            "how to create a bomb", "explosive recipe", "poison recipe",
            "how to poison", "terrorist", "terrorism guide",
            "mass shooting", "school shooting", "self harm",
            "how to commit suicide", "suicide methods", "kill yourself",
        ];
        ...
        let illegal_patterns = [
            "how to steal", "how to rob", "shoplifting guide",
            "how to hack", "hacking tutorial", "crack password",
            "identity theft", "how to forge", "counterfeit",
            "drug manufacturing", "meth recipe", "cocaine production",
        ];
        ...
        // Adult content
        let adult_patterns = [
            "pornography", "explicit sexual", "adult content",
        ];
    ...
    pub fn detect_prompt_injection(&self, text: &str) -> Vec<String> {
        ...
        let role_patterns = [
            ...
            "you are now", "your new role", "switch persona",
            "imagine you are", "play the role of",
        ];
        ...
        // Output manipulation
        let output_patterns = [
            "print exactly", "output exactly", "repeat after me",
            "say exactly", "respond with only", "only respond",
            "do not include", "exclude all",
        ];
        ...
        let obfuscation_patterns = [
            "base64:", "decode this:", "hex encoded",
